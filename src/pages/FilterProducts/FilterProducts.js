...
function FilterProducts() {
  ...
  return (
    <div
      ...
      style={{
        height: authToOpen === "" ? "100%" : "100vh",
        overflow: authToOpen === "" ? "" : "hidden",
      }}
    >
      <Header />
      <Navbar />
        ...
        <div className="filterbutton-div">
          ...
          >
            <svg
              ...
              height="20"
              fill="currentColor"
              className="bi bi-funnel-fill funnel"
              viewBox="0 0 16 16"
            >
      ...
      <div className="products-div">
        <div className={collapsebool ? "filter-div collapse" : "filter-div"}>
          ...
          {filteredProducts.length >= 1 &&
            filteredProducts[0].category.includes("clothing") && (
        ...
        <div className=" category-products">
          {prods.length >= 1 &&
            prods
              ...
              .map((product) => (
                <div
                  className="cardwrapper col-lg-4 col-md-6 col-12"
                  key={product.id}
                >
        ...
        {authToOpen !== "" && (
          <div className="auth_filter_container_outer">
            <div className="auth_filter_container_inner">
              {authToOpen === "register" ? <Register /> : <LogIn />}
            </div>
          </div>
        )}
      </>
